...
<body><form action="doAction.php?act=editUser" method="post">
	<div class="user_mes">
	<?php $link=mysqli_connect(DB_HOST,DB_USER,DB_PWD,DB_DBNAME);
				...
				<table class="mes" style="border-width: 1px;" cellspacing="2" cellpadding="7" border="1" align="center" height="600px;">
					...
					<button  align="center"style="width:300px;font-size:25px;height:30px;font-family:'楷体';left:720px;position:relative;">更改</button>
				</table></div></form>
					<button onclick="goBack()" align="center"style="width:300px;font-size:25px;height:30px;font-family:'楷体';left:720px;position:relative;">返回</button>

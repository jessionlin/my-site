...
<body>
	<form action="userMes.php" method="post">
	<div class="search">
								...
								<table  class="table" style="border-width: 1px;" cellspacing="0" cellpadding="5" border="1" align="center">
									 <thead>
                            			<tr>
                                			...
                                			<th width="10%" align="center">logFlag</th>
                                			<th width="10%" align="center">操作</th>
                            			</tr>
                        			</thead>
									<tbody>
										<?php $link = mysqli_connect(DB_HOST,DB_USER,DB_PWD,DB_DBNAME);
												$sql="select id,name,password,email,phone,QQ,logFlag from user";
												...
												$sql="select id,name,password,email,phone,QQ,logFlag from user limit {$offset},{$pageSize}";
										...
										　	<td align="center"><?php echo $row['phone'];?></td>
											...
											<td align="center"><?php echo $row['logFlag'];?></td>
											<td align="center">
...
<script>
	function ifDes(id){
		if(window.confirm("您确认要删除嘛？")){
			window.location='delMes.php?table=user$target=listUser&id='+id;
		}
	}
</script>
</html>
...
$id=$_REQUEST['id'];
$sql="select id,username,password,email,sex from imooc_admin where id='{$id}'";
$row=fetchOne($sql);
?>
...
<body>
<h3>编辑用户</h3>
	<form action="doAdminAction?act=editUser&id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
